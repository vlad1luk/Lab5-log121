...
public class SecondaryView implements View, Observer {
    private ImageView imageView;
    private ImageModel imageModel;
    private Perspective perspective;

    public SecondaryView(ImageView imageView, ImageModel imageModel, Perspective perspective) {
    ...
    // on met a jour l'affichage de l'interface
    @Override
    public void update() {
